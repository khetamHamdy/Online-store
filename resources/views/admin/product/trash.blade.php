        ...
        <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div>
                    ...
                    <a href="{{url(getLocal().'/admin/product')}}" class="btn btn-secondary  mr-2 btn-info">
                            ...
                            <table class="table table-hover tableWithSearch" id="tableWithSearch">
                                ...
                                @forelse($items as $one)
                                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                                        ...
                                        <td class="v-align-middle wd-25p">{{@$one->brand->name}}</td>
                                        ...
                                        <td class="v-align-middle wd-15p optionAddHours">
                                            <a href="{{url(getLocal().'/admin/product-restore/'.$one->id)}}"
                                               class="btn btn-sm btn-clean btn-icon" title="{{__('cp.restore')}}">
                                                <i class="la la-refresh"></i>
                                            </a>

                                            <a href="{{url(getLocal().'/admin/product-forceDelete/'.$one->id)}}"
