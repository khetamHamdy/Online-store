                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-body pt-4">
                        ...
                        <div class="py-9">
                            ...
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <span class="font-weight-bold mr-2">{{__('cp.discount_price')}}:</span>
                                <span class="text-muted">{{@$item->discount_price}}</span>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <span class="font-weight-bold mr-2">{{__('cp.brand')}}:</span>
                                <span class="text-muted">{{@$item->brand}}</span>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <span class="font-weight-bold mr-2">{{__('cp.category')}}:</span>
                        ...
                        <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                            ...
                            <div class="navi-item mb-2">
                                ...
                                <a href=""
                                   class="navi-link py-4 @if(Route::currentRouteName() == "admin.colors") active  @endif click_action_product"
                                   data-req="colors">
															<span class="navi-icon mr-2">
																<span class="svg-icon">
                                    ...
                                    <span class="navi-text font-size-lg">{{__('cp.colors')}}</span>
                                </a>
                            </div>

                            <div class="navi-item mb-2">
                                <a href=""
                                   class="navi-link py-4 @if(Route::currentRouteName() == "admin.sizes") active  @endif click_action_product"
                                   data-req="sizes">
                                                            <span class="navi-icon mr-2">
                                                                <span class="svg-icon">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <span class="navi-text font-size-lg">{{__('cp.sizes')}}</span>
                                </a>
                            </div>
                            ...
                            <div class="navi-item mb-2">
                                <a href=""
                                   ...
                                   data-req="extras">
                                    ...
                                    <span class="navi-text font-size-lg">{{__('cp.extras')}}</span>
                                </a>
                            </div>
