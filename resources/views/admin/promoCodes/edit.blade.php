        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class="container">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    <form method="post" action="{{url(app()->getLocale().'/admin/promoCodes/'.$item->id)}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="promo_code_type">
                                                <option value="0" @if($item->promo_code_type == 0) selected @endif>
                                                    percentage
                                                </option>
                                                <option value="1" @if($item->promo_code_type == 1) selected @endif>
                                                    amount
                                                </option>
                                            </select>
                                        </div>
