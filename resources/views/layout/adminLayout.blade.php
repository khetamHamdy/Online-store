...
<script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>
    ...
    <style>
        .btn-success{
            background-color: {{@$setting->color_webSite}} !important;
            border: 0 !important;
        }
    .menu-item-here{
            background-color: {{@$setting->color_webSite}} !important;
...
<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
    ...
    <a href="{{url(getLocal().'/admin')}}">
        <img alt="Logo" src="{{@$setting->fav_icon}}"/>
    </a>
    <!--end::Logo-->
    <!--begin::Toolbar-->
        ...
        <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
            ...
            <div class="brand flex-column-auto" id="kt_brand">
                ...
                <a href="{{ url(app()->getLocale().'/admin/home') }}" class="brand-logo">
                    <img alt="Logo" src="{{@$setting->app_logo}}" style="max-width: 60px;"/>
                </a>
                <!--end::Logo-->
                <!--begin::Toggle-->
                ...
                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                    ...
                    <ul class="menu-nav">
                        ...
                        @endif
                            ...
                            <li class="menu-item {{(explode("/", request()->url())[5] == "orders") ? "menu-item-here" : ''}}"
                                ...
                                <a href="{{url(getLocal().'/admin/orders')}}" class="menu-link">
                                    ...
                                    <span class="label label-rounded label-danger" id="count_order">{{$order_count}}</span>
                                </a>
                            </li>
                        @endif
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                            ...
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">{{__('cp.f_product')}}</span>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{url(getLocal().'/admin/extra')}}"
                                           class="menu-link">
                                            ...
                                            <span class="menu-text">{{__('cp.extras')}} </span>
                                        </a>
                                    </li>
                    ...
                    <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{url(getLocal().'/admin/country')}}"
                                           class="menu-link">
                                            ...
                                            <span class="menu-text">{{__('cp.country')}} </span>
                                        </a>
                                    </li>
                                    ...
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="{{url(getLocal().'/admin/city')}}"
                                           class="menu-link">
                                            ...
                                            <span class="menu-text">{{__('cp.city')}} </span>
                                        </a>
                                    </li>
                        ...
                        @if(can(['offers-show' , 'offers-create' , 'offers-edit' , 'offers-delete']))
                            <li class="menu-item {{(explode("/", request()->url())[5] == "offers") ? "menu-item-here" : ''}}"
                                aria-haspopup="true">
                                <a href="{{url(getLocal().'/admin/offers')}}" class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Home/Commode2.svg--><svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                        ...
                        @if(can(['brand-show' , 'brand-create' , 'brand-edit' , 'brand-delete']))
                            <li class="menu-item {{(explode("/", request()->url())[5] == "brand") ? "menu-item-here" : ''}}"
                                aria-haspopup="true">
                                <a href="{{url(getLocal().'/admin/brand')}}" class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Home/Commode2.svg--><svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                    ...
                                    <span class="menu-text">{{__('cp.brand')}}</span>
                                </a>
                            </li>
                        @endif
                        ...
                        @if(can(['sliders-show' , 'sliders-create' , 'sliders-edit' , 'sliders-delete']))
                            <li class="menu-item {{(explode("/", request()->url())[5] == "sliders") ? "menu-item-here" : ''}}"
                                aria-haspopup="true">
                                <a href="{{url(getLocal().'/admin/sliders')}}" class="menu-link">
										<span class="svg-icon menu-icon">
											<!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Home/Commode2.svg--><svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                    ...
                                    <span class="menu-text">{{__('cp.sliders')}}</span>
                                </a>
                            </li>
                        @endif
